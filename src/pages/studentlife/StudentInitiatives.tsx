		...
		<MainLayout title="Студенческие инициативы, проекты, конкурсы">
			...
			>
				<div className="flex-1 flex flex-col justify-center">
					<h2 className="text-blue-700 font-bold text-2xl mb-4">Студенческие инициативы, проекты, конкурсы в ГрГУ</h2>
					<p className="text-gray-600 text-lg leading-relaxed">
						Здесь будет размещена типовая информация о студенческих инициативах, проектах, конкурсах.
					</p>
				</div>
				...
				<div className="w-96 shrink-0 rounded-xl overflow-hidden border-2 border-blue-100">
					<img
						...
						alt="Студенческие инициативы, проекты, конкурсы"
